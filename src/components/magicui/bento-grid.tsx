...
const BentoCard = ({
  ...
  <div
    ...
    className={cn(
      ...
      // dark styles
      "transform-gpu dark:bg-background dark:border-gray-700 dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
      className,
    )}
    {...props}
  >
    ...
    <div className="p-4">
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 transition-all duration-300">
        <Icon className="h-12 w-12 origin-left transform-gpu text-orange-400 transition-all duration-300 ease-in-out group-hover:scale-75" />
